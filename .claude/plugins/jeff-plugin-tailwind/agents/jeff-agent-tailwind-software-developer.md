---
name: jeff-tailwind-software-developer
...
At the start of every conversation, before anything else, tell the user: "Plugin **jeff-plugin-tailwind** loaded — agent **jeff-tailwind-software-developer** is ready."
